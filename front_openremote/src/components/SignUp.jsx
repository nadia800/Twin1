...
const validate = values => {
  ...
  if (!values.country) {
    ...
    if (values.licenseAgreement == false) {
                ...
                <form onSubmit={formik.handleSubmit}>
                    <div className='Sign__box__sidebyside'>
                        <div className='Sign__box__sidebyside__left'>
                            ...
                            <label htmlFor="repeatPassword" className='Sign__box__sidebyside__label'>Repeat Password (Required):</label>
                            <br />
                            <input
                                className='Sign__box__sidebyside__input'
                                id="repeatPassword"
                    ...
                    <div className="checkbox">
                        ...
                        {formik.touched.licenseAgreement ? formik.errors.licenseAgreement ?
                            <div className="message">
                                <FiAlertTriangle />
                                {formik.errors.licenseAgreement}
                            </div> : null : null}
                        <br />
                        <input 
                            type="checkbox" 
